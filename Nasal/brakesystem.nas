    ...
    update : func()
    {
        ...
        if (dt<1.0)
        {
            ...
            if ((OnGround)and(BrakeLevel>0))
            {
                ...
                var Mass = getprop("/fdm/jsbsim/forces/fbz-total-lbs")*-1/me.ScalingDivisor;
...
settimer(func()
         {
           BrakeSys.update();
           print("P-72 Braking System ....... Initialized");
         }, 5);
